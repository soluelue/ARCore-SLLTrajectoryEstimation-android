...
public class Quaternion extends Vector4f {
    ...
    /**
     * @param quaternions [0] : x, [1] : y, [2] : z , [3] : w
     */

    public Quaternion(float [] quaternions){
        super(quaternions[0], quaternions[1], quaternions[2], quaternions[3]);
    }

    public Quaternion(Vector3f vector3f, float w){
        super(vector3f, w);
    }
     ...
     */
    public void convertQuatToMatrix() {
        float x = points[0];
        float y = points[1];
        float z = points[2];
        float w = points[3];
    ...
    public MatrixF4x4 convertQuatToMatrix3X3(){
        MatrixF4x4 matrix = new MatrixF4x4(true);
